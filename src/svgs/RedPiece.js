...
export const RedPiece = ({ handleClick, lightUp }) => {
    ...
    return (
        ...
        <path onClick={(event) => handleClick(+event.target.dataset.id)} data-id="2" pointerEvents="all" d="M4.99996 1V135.167C57.6554 135.167 100.297 177.267 100.297 229.254H236.296C236.296 103.273 132.708 1 4.99996 1Z" fill="red" stroke={lightUp ? "gold": "black"} strokeMiterlimit="10"/>
        </g>
        <defs>
